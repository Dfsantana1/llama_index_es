...
from llama_index_es.multi_modal_llms.replicate_multi_modal import ReplicateMultiModal
...
def test_completion_model_basic(monkeypatch: MonkeyPatch) -> None:
    monkeypatch.setattr(
        "llama_index_es.multi_modal_llms.ReplicateMultiModal.complete", mock_completion
    )
