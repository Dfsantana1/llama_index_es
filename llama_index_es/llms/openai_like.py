...
from llama_index_es.constants import DEFAULT_CONTEXT_WINDOW
from llama_index_es.llms.base import LLMMetadata
from llama_index_es.llms.openai import OpenAI, Tokenizer
...
class OpenAILike(OpenAI):
    ...
    Currently, llama_index_es prevents using custom models with their OpenAI class
