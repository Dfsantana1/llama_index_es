...
if TYPE_CHECKING:
    from llama_index_es.bridge.langchain import BasePromptTemplate as LangchainTemplate
    from llama_index_es.bridge.langchain import (
...
from llama_index_es.llms.generic_utils import messages_to_prompt, prompt_to_messages
from llama_index_es.prompts.prompt_type import PromptType
from llama_index_es.prompts.utils import get_template_vars
...
class LangchainPromptTemplate(BasePromptTemplate):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Must install `llama_index_es[langchain]` to use LangchainPromptTemplate."
            )
        if selector is None:
            if template is None:
    ...
    def format_messages(
        ...
        """Format the prompt into a list of chat messages."""
        from llama_index_es.llms.langchain import LangChainLLM
        from llama_index_es.llms.langchain_utils import from_lc_messages
