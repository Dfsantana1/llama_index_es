...
from llama_index_es.callbacks.arize_phoenix_callback import arize_phoenix_callback_handler
from llama_index_es.callbacks.base_handler import BaseCallbackHandler
from llama_index_es.callbacks.honeyhive_callback import honeyhive_callback_handler
from llama_index_es.callbacks.open_inference_callback import OpenInferenceCallbackHandler
from llama_index_es.callbacks.simple_llm_handler import SimpleLLMHandler
from llama_index_es.callbacks.wandb_callback import WandbCallbackHandler
...
def set_global_handler(eval_mode: str, **eval_params: Any) -> None:
    ...
    llama_index_es.global_handler = create_global_handler(eval_mode, **eval_params)
