...
from llama_index_es.embeddings.adapter import AdapterEmbeddingModel
from llama_index_es.embeddings.base import BaseEmbedding
from llama_index_es.finetuning.embeddings.common import EmbeddingQAFinetuneDataset
from llama_index_es.finetuning.types import BaseEmbeddingFinetuneEngine
from llama_index_es.utils import infer_torch_device
...
class EmbeddingAdapterFinetuneEngine(BaseEmbeddingFinetuneEngine):
    ...
    def __init__(
        ...
        **train_kwargs: Any,
        ...
        from llama_index_es.embeddings.adapter_utils import BaseAdapter, LinearLayer
