...
from llama_index_es.callbacks.base import CallbackManager
from llama_index_es.embeddings.base import BaseEmbedding
from llama_index_es.embeddings.utils import EmbedType, resolve_embed_model
from llama_index_es.indices.prompt_helper import PromptHelper
from llama_index_es.llm_predictor import LLMPredictor
from llama_index_es.llm_predictor.base import BaseLLMPredictor, LLMMetadata
from llama_index_es.llms.base import LLM
from llama_index_es.llms.utils import LLMType, resolve_llm
from llama_index_es.logger import LlamaLogger
from llama_index_es.node_parser.interface import NodeParser, TextSplitter
from llama_index_es.node_parser.text.sentence import (
    DEFAULT_CHUNK_SIZE,
...
from llama_index_es.types import PydanticProgramMode
...
class ServiceContext:
    ...
    def from_defaults(
        ...
        You can change the base defaults by setting llama_index_es.global_service_context
        ...
        if llama_index_es.global_service_context is not None:
            return cls.from_service_context(
                llama_index_es.global_service_context,
    ...
    def from_dict(cls, data: dict) -> "ServiceContext":
        from llama_index_es.embeddings.loading import load_embed_model
        from llama_index_es.extractors.loading import load_extractor
        from llama_index_es.llm_predictor.loading import load_predictor
        from llama_index_es.node_parser.loading import load_parser
...
def set_global_service_context(service_context: Optional[ServiceContext]) -> None:
    ...
    llama_index_es.global_service_context = service_context
