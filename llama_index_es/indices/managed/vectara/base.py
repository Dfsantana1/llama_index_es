...
from llama_index_es.data_structs.data_structs import IndexDict, IndexStructType
from llama_index_es.indices.managed.base import BaseManagedIndex, IndexType
from llama_index_es.schema import BaseNode, Document, MetadataMode, TextNode
...
class VectaraIndex(BaseManagedIndex):
    ...
    def _insert(
        ...
        **insert_kwargs: Any,
        ...
        for node in nodes:
            ...
            metadata["framework"] = "llama_index_es"
    ...
    def insert_file(
        ...
        **insert_kwargs: Any,
        ...
        This method provides a way to use that API in llama_index_es.
