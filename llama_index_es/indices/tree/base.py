...
from llama_index_es.indices.common_tree.base import GPTTreeIndexBuilder
from llama_index_es.indices.tree.inserter import TreeIndexInserter
...
class TreeIndex(BaseIndex[IndexGraph]):
    ...
    def as_retriever(
        ...
        **kwargs: Any,
        ...
        from llama_index_es.indices.tree.select_leaf_retriever import (
