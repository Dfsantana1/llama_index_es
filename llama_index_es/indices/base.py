...
from llama_index_es.chat_engine.types import BaseChatEngine, ChatMode
from llama_index_es.core import BaseQueryEngine, BaseRetriever
from llama_index_es.data_structs.data_structs import IndexStruct
from llama_index_es.ingestion import run_transformations
from llama_index_es.llms.openai import OpenAI
from llama_index_es.llms.openai_utils import is_function_calling_model
from llama_index_es.schema import BaseNode, Document
from llama_index_es.service_context import ServiceContext
from llama_index_es.storage.docstore.types import BaseDocumentStore, RefDocInfo
...
class BaseIndex(Generic[IS], ABC):
    ...
    def as_chat_engine(
        ...
        if chat_mode == ChatMode.CONDENSE_QUESTION:
            # NOTE: lazy import
            from llama_index_es.chat_engine import CondenseQuestionChatEngine
            ...
            from llama_index_es.chat_engine import ContextChatEngine
            ...
            from llama_index_es.chat_engine import CondensePlusContextChatEngine
            ...
            from llama_index_es.chat_engine import SimpleChatEngine
