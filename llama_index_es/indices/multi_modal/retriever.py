...
from llama_index_es.core import (
    MultiModalRetriever,
)
...
from llama_index_es.indices.utils import log_vector_store_query_result
from llama_index_es.schema import NodeWithScore, ObjectType, QueryBundle, QueryType
