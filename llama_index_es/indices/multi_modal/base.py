...
from llama_index_es.data_structs.data_structs import IndexDict, MultiModelIndexDict
from llama_index_es.embeddings.multi_modal_base import MultiModalEmbedding
from llama_index_es.embeddings.utils import EmbedType, resolve_embed_model
from llama_index_es.indices.utils import (
...
from llama_index_es.schema import BaseNode, ImageNode
...
from llama_index_es.vector_stores.simple import DEFAULT_VECTOR_STORE, SimpleVectorStore
...
class MultiModalVectorStoreIndex(VectorStoreIndex):
    ...
    def as_retriever(self, **kwargs: Any) -> BaseRetriever:
        # NOTE: lazy import
        from llama_index_es.indices.multi_modal.retriever import (
