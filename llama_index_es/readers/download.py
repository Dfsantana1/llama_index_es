...
from llama_index_es.download.download_utils import LLAMA_HUB_URL, download_llama_module
...
def download_loader(
    ...
    Args:
        ...
        use_gpt_index_import: If true, the loader files will use
            llama_index_es as the base dependency. By default (False),
            the loader files use llama_index_es as the base dependency.
