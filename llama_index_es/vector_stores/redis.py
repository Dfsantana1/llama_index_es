...
from llama_index_es.readers.redis.utils import (
    TokenEscaper,
    array_to_buffer,
...
from llama_index_es.vector_stores.utils import metadata_dict_to_node, node_to_metadata_dict
...
class RedisVectorStore(VectorStore):
    ...
    def __init__(
        self,
        index_name: str,
        index_prefix: str = "llama_index_es",
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            index_prefix (str): Prefix for the index. Defaults to "llama_index_es".
            ...
            prefix_ending (str): Prefix ending for the index. Be careful when
                changing this: https://github.com/jerryjliu/llama_index_es/pull/6665.
                Defaults to "/vector".
