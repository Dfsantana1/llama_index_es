...
from llama_index_es.vector_stores.utils import (
...
class RocksetVectorStore(VectorStore):
    ...
    def __init__(
        ...
        Args:
            ...
            text_key (str): The key to the text of nodes
                (default: llama_index_es.vector_stores.utils.DEFAULT_TEXT_KEY)
            embedding_col (str): The DB column containing embeddings
                (default: llama_index_es.vector_stores.utils.DEFAULT_EMBEDDING_KEY))
        ...
        try:
            self.rs.set_application("llama_index_es")
    ...
    def query(self, query: VectorStoreQuery, **kwargs: Any) -> VectorStoreQueryResult:
        ...
        Args:
            query (llama_index_es.vector_stores.types.VectorStoreQuery): The query
            similarity_col (Optional[str]): The column to select the cosine
                similarity as (default: "_similarity")

        Returns:
            query results (llama_index_es.vector_stores.types.VectorStoreQueryResult)
        """
