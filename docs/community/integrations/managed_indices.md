...
First, [sign up](https://vectara.com/integrations/llama_index_es) and use the Vectara Console to create a corpus (aka Index), and add an API key for access.
...
```python
from llama_index_es import ManagedIndex, SimpleDirectoryReade
